...
use ApplicationServiceBundle\Service\SprintObserver\SprintSMSObserver;
use DomainBundle\Entity\Sprint;
use DomainBundle\Entity\SprintState\SprintStateNew;
use PHPUnit\Framework\TestCase;

class SprintSMSObserverTest extends TestCase
{
    /**
     * @return void
     */
    public function testIfUpdateIsHandledCorrectly(): void
    {
        ...
        $notifyHandler->expects($this->once())
            ->method('sendMessage');
        $sprintObserver = new SprintSMSObserver($notifyHandler);
