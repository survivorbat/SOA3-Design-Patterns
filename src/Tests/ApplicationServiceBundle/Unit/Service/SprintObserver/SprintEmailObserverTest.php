...
use ApplicationServiceBundle\Service\SprintObserver\SprintEmailObserver;
use DomainBundle\Entity\Sprint;
use DomainBundle\Entity\SprintState\SprintStateNew;
use PHPUnit\Framework\TestCase;

class SprintEmailObserverTest extends TestCase
{
    /**
     * @return void
     */
    public function testIfUpdateIsHandledCorrectly(): void
    {
        ...
        $notifyHandler->expects($this->once())
            ->method('sendMessage');
        $sprintObserver = new SprintEmailObserver($notifyHandler);
