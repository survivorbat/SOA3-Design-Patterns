    ...
    public function testIfExportFunctionCallsFileSystemAndReturnsJson(): void
    {
        ...
        $fileSystemMock->expects($this->once())
            ...
            ->with(
                ...
                '{"editable":true,"exportHandler":[],"id":"","name":"Sprint 0","createdAt":{"timezone":{"name":"-04:00","transitions":false,"location":false},"offset":-14400,"timestamp":1503159475},"currentState":{"editable":true,"stateDescription":"Deze sprint is nieuw en nog niet begonnen."}}'
            );
